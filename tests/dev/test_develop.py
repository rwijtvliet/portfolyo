...
def test_index(freq, tz, startdate, start_of_day):
    """Test index creation."""
    _ = dev._get_index() if freq is None else dev._get_index(freq, tz, startdate)
...
def test_series(freq, tz, startdate, name, name_has_unit, request_unit, start_of_day):
    ...
    i = None if freq is None else dev._get_index(freq, tz, startdate, startofday=start_of_day)
