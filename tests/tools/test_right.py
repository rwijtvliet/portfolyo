...
TESTCASES_DST = [  # ts, freq, expected_ts_right
    # Start of DST.
    ("2020-03-29 01:00", "15T", "2020-03-29 01:15"),
    ("2020-03-29 01:00", "H", "2020-03-29 03:00"),
    ("2020-03-29 00:00", "D", "2020-03-30 00:00"),
    ("2020-03-29 01:00", "D", "2020-03-30 01:00"),
    ("2020-03-29 03:00", "D", "2020-03-30 03:00"),
    ("2020-03-29 06:00", "D", "2020-03-30 06:00"),
    ("2020-03-01 00:00", "MS", "2020-04-01 00:00"),
    ("2020-03-01 06:00", "MS", "2020-04-01 06:00"),
    ("2020-01-01 00:00", "QS", "2020-04-01 00:00"),
    ("2020-01-01 06:00", "QS", "2020-04-01 06:00"),
    # End of DST.
    ("2020-10-25 01:00", "15T", "2020-10-25 01:15+0200"),
    ("2020-10-25 02:00+0200", "15T", "2020-10-25 02:15+0200"),
    ("2020-10-25 02:00+0100", "15T", "2020-10-25 02:15+0100"),
    ("2020-10-25 03:00", "15T", "2020-10-25 03:15"),
    ("2020-10-25 01:00", "H", "2020-10-25 02:00+0200"),
    ("2020-10-25 02:00+0200", "H", "2020-10-25 02:00+0100"),
    ("2020-10-25 02:00+0100", "H", "2020-10-25 03:00"),
    ("2020-10-25 03:00", "H", "2020-10-25 04:00"),
    ("2020-10-25 00:00", "D", "2020-10-26 00:00"),
    ("2020-10-25 01:00", "D", "2020-10-26 01:00"),
    ("2020-10-25 03:00", "D", "2020-10-26 03:00"),
    ("2020-10-25 06:00", "D", "2020-10-26 06:00"),
    ("2020-10-01 00:00", "MS", "2020-11-01 00:00"),
    ("2020-10-01 06:00", "MS", "2020-11-01 06:00"),
    ("2020-10-01 00:00", "QS", "2021-01-01 00:00"),
    ("2020-10-01 06:00", "QS", "2021-01-01 06:00"),
]
...
def test_right_index(ts: str, freq: str, tz: str, expected_ts_right: str):
    ...
    do_test_index(ts, freq, tz, expected_ts_right)


@pytest.mark.parametrize(("ts", "freq", "expected_ts_right"), TESTCASES_DST)
def test_right_index_dst(ts: str, freq: str, expected_ts_right: str):
    """Test if right timestamp is correctly calculated for index with dst-transition."""
    do_test_index(ts, freq, "Europe/Berlin", expected_ts_right)
...
def do_test_index(ts, freq, tz, expected_ts_right):
    # Must specify timezone in timestamp (instead of index) to avoid confusion at DST-changeover.
    i = pd.date_range(pd.Timestamp(ts, tz=tz), freq=freq, periods=100)
    result = tools.right.index(i)
    expected = pd.date_range(
        pd.Timestamp(expected_ts_right, tz=tz), freq=freq, periods=100, name="right"
    )
    testing.assert_index_equal(result, expected)
    tools.standardize.assert_index_standardized(result, True)
