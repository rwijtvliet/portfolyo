...
def test_pfline_plot(
    levels: int, childcount: int, children: str, kind: Kind, freq: str
):
...
@pytest.mark.parametrize("children", ["True", "False"])
def test_flatpfline_plot(children: str):
...
@pytest.mark.parametrize("levels", [1, 2, 3])
@pytest.mark.parametrize("childcount", [1, 2, 3])
def test_plot_to_ax(levels: int, childcount: int, children: str, freq: str):
