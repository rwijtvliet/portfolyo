...
@pytest.fixture(
    ...
    params=[
        ...
        (
            ("2020", "2023", "min"),
            ("2021-04-21", "2023-02", "h"),
            ("2021-04-21", "2023"),
        ),
        (
            ("2020", "2023", "min"),
            ("2021-04-21", "2023-02", "D"),
            ("2021-04-21", "2023"),
        ),
...
@pytest.fixture(
    scope="class",
    params=[
        pytest.param(True, id="ignorefreq"),
        pytest.param(False, id="dontignorefreq"),
    ],
)
...
@pytest.fixture(
    scope="class",
    params=[
        pytest.param(True, id="ignoresod"),
        pytest.param(False, id="dontignoresod"),
    ],
)
...
def case4_flexintersect_idxs(
    ...
    if _case4_itsidx_isempty:
        return (
            pd.DatetimeIndex([], freq=freq1, tz=tz),
            pd.DatetimeIndex([], freq=freq2, tz=tz2),
        )
    else:
        return (
