...
class TestIndexCase4:
    def test_normalintersect_ok(case4_idx1, case4_idx2, case4_normalintersect_idx):
        toolsb.testing.assert_index_equal(
            toolsb.index.intersect([case4_idx1, case4_idx2]), case4_normalintersect_idx
        )

    def test_normalintersect_nok(case4_idx1, case4_idx2, case4_normalintersect_isok):
