...
dataset1 = {
    "offtake": create.flatpfline({"w": pd.Series([-3.5, -5, -5], i1, dtype="pint[MW]")}),
...
dataset2 = {
    "offtake": create.flatpfline({"w": pd.Series([-15.0, -20, -4], i2, dtype="pint[MW]")}),
    "unsourcedprice": create.flatpfline(
