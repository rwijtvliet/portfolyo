...
@pytest.mark.parametrize(
    ...
    [
        ...
        # . Add volume.
        # . . single value
        (i, Kind.VOLUME, Q_(0, "MWh"), PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, Q_(8.1, "Wh"), PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, Q_(8.1, "kWh"), PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, Q_(8.1, "MWh"), PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, Q_(8.1, "GWh"), PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, Q_(8.1, "W"), PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, Q_(8.1, "kW"), PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, Q_(8.1, "MW"), PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, Q_(8.1, "GW"), PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, {"w": Q_(8.1, "GW")}, PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, {"w": 8.1}, PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, pd.Series([8.1], ["q"]), PfLine, Kind.VOLUME),
        (
            i,
            Kind.VOLUME,
        ...
        (i, Kind.VOLUME, pd.Series([8.1], ["w"]), PfLine, Kind.VOLUME),
        (
            i,
            Kind.VOLUME,
        ...
        (i, Kind.VOLUME, Q_(8.1, "J"), PfLine, Kind.VOLUME),
        ...
        (
            i,
            Kind.VOLUME,
            dev.get_singlepfline(i, Kind.VOLUME, _random=False),
            PfLine,
            Kind.VOLUME,
        ),
        (
            i,
            Kind.VOLUME,
            dev.get_multipfline(i, Kind.VOLUME, _random=False),
            PfLine,
            Kind.VOLUME,
        ),
        # . Add something else.
        # . . single value
        (i, Kind.VOLUME, 0, PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, 0.0, PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, None, PfLine, Kind.VOLUME),
        (i, Kind.VOLUME, 8.1, Exception, None),
        (i, Kind.VOLUME, Q_(8.1, ""), Exception, None),
        (i, Kind.VOLUME, Q_(8.1, "Eur/MWh"), Exception, None),
        (i, Kind.VOLUME, Q_(8.1, "Eur"), Exception, None),
        (i, Kind.VOLUME, Q_(8.1, "h"), Exception, None),
        (i, Kind.VOLUME, Q_(0.0, "Eur/MWh"), Exception, None),
        (i, Kind.VOLUME, {"the_volume": Q_(8.1, "MWh")}, Exception, None),
        # . . timeseries (series, df, pfline)
        (
            i,
            Kind.VOLUME,
        ...
        (i, Kind.VOLUME, dev.get_series(i, "p", _random=False), Exception, None),
        (i, Kind.VOLUME, dev.get_series(i, "r", _random=False), Exception, None),
        (
            i,
            Kind.VOLUME,
        ...
        (
            i,
            Kind.VOLUME,
            dev.get_singlepfline(i, Kind.PRICE, _random=False),
            Exception,
            None,
        ),
        (
            i,
            Kind.VOLUME,
            dev.get_multipfline(i, Kind.PRICE, _random=False),
            Exception,
            None,
        ),
        (
            i,
            Kind.VOLUME,
            dev.get_singlepfline(i, Kind.COMPLETE, _random=False),
            Exception,
            None,
        ),
        (
            i,
            Kind.VOLUME,
            dev.get_multipfline(i, Kind.COMPLETE, _random=False),
            Exception,
            None,
        ),
        # Adding to price pfline.
        # . Add dimension-agnostic.
        (i, Kind.PRICE, 12, PfLine, Kind.PRICE),
        (
            i,
            Kind.PRICE,
        ...
        # . Add price.
        (i, Kind.PRICE, Q_(0, "Eur/MWh"), PfLine, Kind.PRICE),
        (i, Kind.PRICE, Q_(12.0, "Eur/MWh"), PfLine, Kind.PRICE),
        (i, Kind.PRICE, Q_(12.0, "Eur/kWh"), PfLine, Kind.PRICE),
        (i, Kind.PRICE, Q_(12.0, "cent/kWh"), PfLine, Kind.PRICE),
        (
            i,
            Kind.PRICE,
        ...
        # . Add something else.
        (i, Kind.PRICE, 0, PfLine, Kind.PRICE),
        (i, Kind.PRICE, 0.0, PfLine, Kind.PRICE),
        (i, Kind.PRICE, None, PfLine, Kind.PRICE),
        (i, Kind.PRICE, Q_(12.0, ""), Exception, None),  # explicitly dimensionless
        (i, Kind.PRICE, Q_(12.0, "Eur"), Exception, None),
        (i, Kind.PRICE, Q_(12.0, "MWh"), Exception, None),
        (i, Kind.PRICE, Q_(12.0, "h"), Exception, None),
        (i, Kind.PRICE, Q_(0.0, "MWh"), Exception, None),
        (i, Kind.PRICE, dev.get_series(i, "q", _random=False), Exception, None),
        (
            i,
            Kind.PRICE,
            dev.get_singlepfline(i, Kind.VOLUME, _random=False),
        ...
        # . Add dimension-agnostic.
        (i, Kind.COMPLETE, 5.9, Exception, None),
        (
            i,
            Kind.COMPLETE,
            dev.get_series(i, "q", _random=False).pint.magnitude,
        ...
        (i, Kind.COMPLETE, {"nodim": 5.9}, Exception, None),
        (i, Kind.COMPLETE, {"nodim": Q_(5.9, "")}, Exception, None),
        # . Add other 'all' pfline.
        (i, Kind.COMPLETE, Q_(6.0, "Eur"), SinglePfLine, Kind.COMPLETE),
        (
            i,
            Kind.COMPLETE,
            dev.get_series(i, "r", _random=False),
            SinglePfLine,
            Kind.COMPLETE,
        ),
        (
            i,
            Kind.COMPLETE,
            dev.get_dataframe(i, "r", _random=False),
            SinglePfLine,
            Kind.COMPLETE,
        ),
        (
        ...
        # . Add something else.
        (i, Kind.COMPLETE, Q_(6.0, "Eur/MWh"), Exception, None),
        (i, Kind.COMPLETE, Q_(6.0, "MW"), Exception, None),
        (i, Kind.COMPLETE, Q_(6.0, "MWh"), Exception, None),
        (i, Kind.COMPLETE, Q_(6.0, "h"), Exception, None),
        (i, Kind.COMPLETE, dev.get_series(i, "p", _random=False), Exception, None),
        (i, Kind.COMPLETE, dev.get_series(i, "q", _random=False), Exception, None),
        (i, Kind.COMPLETE, dev.get_series(i, "w", _random=False), Exception, None),
        (i, Kind.COMPLETE, dev.get_dataframe(i, "p", _random=False), Exception, None),
        (i, Kind.COMPLETE, dev.get_dataframe(i, "q", _random=False), Exception, None),
        (i, Kind.COMPLETE, dev.get_dataframe(i, "w", _random=False), Exception, None),
        (i, Kind.COMPLETE, dev.get_dataframe(i, "wq", _random=False), Exception, None),
        (
            i,
            Kind.COMPLETE,
            dev.get_singlepfline(i, Kind.PRICE, _random=False),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        # . . single value
        (i, Kind.VOLUME, 8.1, PfLine, Kind.VOLUME, PfLine, Kind.VOLUME),
        (
            i,
            Kind.VOLUME,
            Q_(8.1, ""),
        ...
        # . . single val
        (i, Kind.VOLUME, Q_(8.1, "Wh"), Exception, None, pd.Series, None),
        (i, Kind.VOLUME, Q_(8.1, "kWh"), Exception, None, pd.Series, None),
        (i, Kind.VOLUME, Q_(8.1, "MWh"), Exception, None, pd.Series, None),
        (i, Kind.VOLUME, Q_(8.1, "GWh"), Exception, None, pd.Series, None),
        (i, Kind.VOLUME, Q_(8.1, "W"), Exception, None, pd.Series, None),
        (i, Kind.VOLUME, Q_(8.1, "kW"), Exception, None, pd.Series, None),
        (i, Kind.VOLUME, Q_(8.1, "MW"), Exception, None, pd.Series, None),
        (i, Kind.VOLUME, Q_(8.1, "GW"), Exception, None, pd.Series, None),
        (i, Kind.VOLUME, {"w": Q_(8.1, "GW")}, Exception, None, pd.Series, None),
        (i, Kind.VOLUME, {"w": 8.1}, Exception, None, pd.Series, None),
        (i, Kind.VOLUME, Q_(8.1, "J"), Exception, None, pd.Series, None),
        (
            i,
            Kind.VOLUME,
            pd.Series([8.1], ["q"]),
        ...
        (
            i,
            Kind.VOLUME,
            dev.get_pfline(i, Kind.VOLUME, _random=False),
            Exception,
            None,
            pd.Series,
            None,
        ...
        # . Multiply with price
        # . . single val
        (i, Kind.VOLUME, Q_(8.1, "Eur/MWh"), PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.VOLUME, Q_(8.1, "ctEur/kWh"), PfLine, Kind.COMPLETE, Exception, None),
        # . . timeseries (series, df, pfline)
        (
            i,
            Kind.VOLUME,
        ...
        # . Multiply with dimensionless value
        # . . single value
        (i, Kind.PRICE, 8.1, PfLine, Kind.PRICE, PfLine, Kind.PRICE),
        (
            i,
            Kind.PRICE,
            Q_(8.1, ""),
        ...
        # . Multiply with volume
        # . . single val
        (i, Kind.PRICE, Q_(8.1, "Wh"), PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, Q_(8.1, "kWh"), PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, Q_(8.1, "MWh"), PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, Q_(8.1, "GWh"), PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, Q_(8.1, "W"), PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, Q_(8.1, "kW"), PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, Q_(8.1, "MW"), PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, Q_(8.1, "GW"), PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, {"w": Q_(8.1, "GW")}, PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, {"w": 8.1}, PfLine, Kind.COMPLETE, Exception, None),
        (i, Kind.PRICE, Q_(8.1, "J"), PfLine, Kind.COMPLETE, Exception, None),
        (
            i,
            Kind.PRICE,
            pd.Series([8.1], ["q"]),
        ...
        # . Multiply with price
        # . . single val
        (i, Kind.PRICE, Q_(8.1, "Eur/MWh"), Exception, None, pd.Series, None),
        (i, Kind.PRICE, Q_(8.1, "ctEur/kWh"), Exception, None, pd.Series, None),
        # . . timeseries (series, df, pfline)
        (
            i,
            Kind.PRICE,
...
pflset1 = {
    Kind.VOLUME: pf.SinglePfLine({"w": series1["w"]}),
    Kind.PRICE: pf.SinglePfLine({"p": series1["p"]}),
    Kind.COMPLETE: pf.SinglePfLine({"w": series1["w"], "p": series1["p"]}),
}
series2 = {
...
pflset2 = {
    Kind.VOLUME: pf.SinglePfLine({"w": series2["w"]}),
    Kind.PRICE: pf.SinglePfLine({"p": series2["p"]}),
    Kind.COMPLETE: pf.SinglePfLine({"w": series2["w"], "p": series2["p"]}),
}
